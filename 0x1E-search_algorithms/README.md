# C - Search Algorithms
This project is an implementation of search algorithms in C. The concentration is binary and linear search.

## More Info
Some files are answer files containing big O notations and therefore use the format:
